...
public class ExpenseGroupBalanceServiceTest {
    ...
    public void normalize_zeroNetBalance_savesNothing() {
        ...
        ExpenseGroupBalance balance2to1 = new ExpenseGroupBalance(1, user1, user2, new BigDecimal("50.00"), group);
        ExpenseGroupBalance balance1to2 = new ExpenseGroupBalance(2, user2, user1, new BigDecimal("50.00"), group);
    ...
    public void getAllBalancesByGroup_success() {
        ...
        assertEquals(balances.get(0).creditor().id(), result.balances().get(0).creditorId());
        assertEquals(balances.get(0).debtor().id(), result.balances().get(0).debtorId());
