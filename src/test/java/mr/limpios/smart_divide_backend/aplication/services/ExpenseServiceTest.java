...
public class ExpenseServiceTest {
    ...
    public void addExpense_success() {
        ...
        try (MockedStatic<ExpenseValidator> validatorMock = Mockito.mockStatic(ExpenseValidator.class);
                MockedStatic<ExpenseModelAssembler> assemblerMock = Mockito.mockStatic(ExpenseModelAssembler.class)) {
            ...
            validatorMock.verify(() -> ExpenseValidator.validateGroupMembership(anyMap(), eq(userId), eq(inputDTO)));
    ...
    public void addExpense_groupNotFound_throwsException() {
        ...
        ResourceNotFoundException ex = assertThrows(ResourceNotFoundException.class,
                () -> expenseService.addExpense(Instancio.create(ExpenseInputDTO.class), "user-1", groupId));
