...
@WebMvcTest(
    controllers = GroupsController.class,
...
class GroupsControllerTest {
    ...
    void createGroup_success() throws Exception {
        ...
        mockMvc.perform(post("/user/{userId}/groups", userId)
    ...
    void updateGroup_success() throws Exception {
        ...
        mockMvc.perform(put("/user/{userId}/groups/{groupId}", userId, groupId)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(inputDTO)))
    ...
    void addMember_success() throws Exception {
        ...
        mockMvc.perform(put("/user/{userId}/groups/{groupId}/members", userId, groupId)
                .contentType(MediaType.APPLICATION_JSON)
                .content(objectMapper.writeValueAsString(inputDTO)))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.ok").value(true))
    ...
    void getUserGroups_success() throws Exception {
        ...
        mockMvc.perform(get("/user/{userId}/groups", userId)
                .contentType(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.ok").value(true))
    ...
    void getGroupTransactions_success() throws Exception {
        ...
        mockMvc.perform(get("/user/{userId}/groups/{groupId}/transactions", userId, groupId)
                .contentType(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.ok").value(true))
            .andExpect(jsonPath("$.body.id").value(responseDTO.id()));
    ...
    void getGroupMembers_success() throws Exception {
        ...
        mockMvc.perform(get("/user/{userId}/groups/{groupId}/members", userId, groupId)
                .contentType(MediaType.APPLICATION_JSON))
            .andExpect(status().isOk())
            .andExpect(jsonPath("$.ok").value(true))
