...
public class ExpenseMapper {
    ...
    public static ExpenseSchema toSchema(Expense expense) {
        ...
        expenseSchema.setParticipants(ExpenseParticipantMapper.toSchemaList(expense.participants(), expenseSchema));
    ...
    public static Expense toEntity(AddExpenseDTO dto, Group group, List<ExpenseParticipant> participants,
