...
public class ExpenseValidationStrategyFactory {
  ...
  public ExpenseValidationStrategyFactory(
      Map<String, ExpenseDivisionValidationStrategy> strategyMap) {
    this.strategies = Map.of(DivisionType.EQUAL, new EqualDivisionValidationStrategy(),
        DivisionType.CUSTOM, new SumMatchValidationStrategy(), DivisionType.PERCENTAGE,
        new SumMatchValidationStrategy());
  }
